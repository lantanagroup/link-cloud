...
from 'src/app/interfaces/validation/validation-category.interface';

import {
  ValidationService
}

from 'src/app/services/gateway/validation/validation.service';
...
@Component( {
  ...
  onSubmit(): void {
    if (this.categoryForm.valid) {
      ...
      const updatedCategory: IValidationCategory= {
        id: this.categoryId,
