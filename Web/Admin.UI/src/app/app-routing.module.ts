...
const routes: Routes = [
  ...
  // { path: 'validation-config/validation-categories-list/:id/edit', loadComponent: () => import('./components/validation-config/validation-categories/edit-validation-category/edit-validation-category.component').then(mod => mod.EditValidationCategoryComponent) },
  { path: '**', redirectTo: '' },
];
