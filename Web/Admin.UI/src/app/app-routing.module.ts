...
const routes: Routes = [
  ...
  { path: 'sub-pre-qual-report/facility/:facilityId/report/:submissionId/:category', loadComponent: () => import('./components/sub-pre-qual-report/sub-pre-qual-report-issues/sub-pre-qual-report-issues.component').then(mod => mod.SubPreQualReportIssuesComponent) },
