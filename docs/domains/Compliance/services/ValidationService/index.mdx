...
| link.terminology-service-url      | Base URL of the Link Terminology Service; service appends /api/terminology/fhir automatically         | URL                             | No      |
| link.fhir-terminology-service-url | URL of an external standards-compliant FHIR Terminology server used directly for terminology calls    | URL                             | No      |
