...
* **Normalization Testing Proxy**: Routes testing requests from the Admin UI to the NormalizationService, enabling secure operation validation through the administrative interface.
