...
| PatientListAcquired-Retry | Consumer  | 															                                             |
| PatientListAcquired-Error | Producer  | 															                                             |
...
TODO: Query Dispatch is omitted from proposal. Data Acquisition needs to consume patient events 
...
| Request Type | Proposed Route       									  		  | Current												  					|  
| ------------ | --------------------------							  		  | ------- 											  					|
| GET					 | /info 			                  					  		  |	N/A		  											  					|
| GET					 | /artifacts	                  					  		  |	/api/validation/artifact			  					|
| POST				 | /artifacts	                  					  		  |	/api/validation/artifact/$initialize			|
| PUT				   | /artifacts/packages/{name}  						  		  | /api/validation/artifact/{type}/{name}    |
| GET				   | /artifacts/packages/types/{type}/names/{name} 	| /api/validation/artifact/{type}/{name}    |

TODO: Incomplete API list
