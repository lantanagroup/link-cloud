...
erDiagram
    ...
    FACILITY 1 to one or more USERS : configures
    TENANT 1 to one or more USERS : configures
    ...
    TENANT 1 to 1 QUERY_DISPATCH_SCHEDULE : configures
    TENANT 1 to 1 ACQUISITION_DATA_SOURCE : configures
    FACILITY 1 to 1 ACQUISITION_DATA_SOURCE : configures
    FACILITY 1 to 1 CENSUS_EVENT : has
    CENSUS_EVENT 1 to one or more FHIR_LIST: source
    CENSUS_EVENT 1 to one or more SFTP_FILE: source
