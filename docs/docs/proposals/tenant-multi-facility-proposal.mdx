...
| POST				 | /artifacts	                  					  		  		|	Replaces /api/validation/artifact/$initialize				|
| PUT				   | /artifacts/packages/\{name\}  						  		    | Replaces /api/validation/artifact/\{type\}/\{name\}  |
| GET				   | /artifacts/packages/types/\{type\}/names/\{name\} 	| Replaces /api/validation/artifact/\{type\}/\{name\}  |
