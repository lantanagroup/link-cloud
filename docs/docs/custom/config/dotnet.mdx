...
## Data Acquisition Worker Configuration

# AcquisitionWorkerProcessorSettings

The AcquisitionWorkerProcessorSettings configuration allows exposing allows the setting of configuration for concurrency and channel size.

| Property                                                         | Description                                           | Required | Default Value | Secret? |
|------------------------------------------------------------------|-------------------------------------------------------|----------|---------------|---------|
| AcquisitionWorkerProcessorSettings__MaxConcurrentAcquisitions    | Sets the concurrency for processing of kafka messages | No       | 8             | No      |
| AcquisitionWorkerProcessorSettings__WorkChannelCapacity          | Capacity of channel for a DAW instance                | No       | 200           | No      |
