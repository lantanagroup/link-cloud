...
summary: Guidance on using Open Telemetry within the Link platform
---
...
The TraceExporterEndpoint and MetricsEndpoint are only used if you want to connect directly to a Tracing service like [Jaeger Tracing](https://www.jaegertracing.io/) or a metrics scraper like [prometheus.io](https://prometheus.io/). The TelemetryCollectorEndpoint should be what you are targeting for any moving beyond your local development environment.
