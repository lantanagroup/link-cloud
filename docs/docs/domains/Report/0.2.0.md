...
state "Measure Report Generated" as MeasureReportGenerated
...
PatientListsAcquired --> MeasureReportGenerated : MeasureReportGeneratedValue (for each patient)
MeasureReportGenerated --> ValidationComplete : ReadyForValidationValue
...
MeasureReportGenerated --> ReportGenerationFailed : Error
