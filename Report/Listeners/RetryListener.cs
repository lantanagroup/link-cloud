...
namespace LantanaGroup.Link.Report.Listeners
{
    public class RetryListener : BackgroundService
    {
        ...
        private async void StartConsumerLoop(CancellationToken cancellationToken)
        {
            ...
            try
            {
                consumer.Subscribe(KafkaTopic.ReportScheduledRetry.GetStringValue());
                consumer.Subscribe(KafkaTopic.MeasureEvaluatedRetry.GetStringValue());
                consumer.Subscribe(KafkaTopic.ReportSubmittedRetry.GetStringValue());
                consumer.Subscribe(KafkaTopic.PatientsToQueryRetry.GetStringValue());
