...
public class CensusSchedulingRepository : ICensusSchedulingRepository
{
    ...
    public async Task AddJobForFacility(CensusConfigModel censusConfig, IScheduler scheduler = null)
    {
    ...
    public async Task CreateJobAndTrigger(CensusConfigModel facility, IScheduler scheduler)
    {
    ...
    public async Task UpdateJobsForFacility(CensusConfigModel config, IScheduler scheduler = null)
    {
        scheduler ??= await _schedulerFactory.GetScheduler();
        scheduler.JobFactory = _jobFactory;
