...
namespace LantanaGroup.Link.LinkAdmin.BFF.Application.Clients
{
    public class NotificationService
    {
        ...
        {
            //check if the notification service uri is set
            ...
            // HTTP GET
            HttpResponseMessage response = await _client.GetAsync($"{_serviceRegistry.Value.NotificationServiceUrl}/health", cancellationToken);
