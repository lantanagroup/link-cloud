...
{
    public Task<(bool isQueryParam, object authHeaderValue)> SetAuthentication(string facilityId, AuthenticationConfiguration authSettings)
    {
        ...
        try
        {
            ...
            return Task.FromResult<(bool, object)>((false,
