...
public class StringSecurityExtensionsTest
{
    ...
    public void SanitizeForLog_WithPrintableAscii_ReturnsUnchanged(string input, string expected)
    {
        // Act
    ...
    public void SanitizeForLog_WithControlCharacters_ReplacesWithSpace(string input, string expected)
    {
        // Act
        var result = input.SanitizeForLog();
    ...
    [Fact]
    public void SanitizeForLog_WithNullCharacter_ReplacesWithSpace()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_WithLowControlCharacters_ReplacesWithSpace()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_WithEscapeCharacter_ReplacesWithSpace()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_WithDeleteCharacter_ReplacesWithSpace()
    {
    ...
    [Fact]
    public void SanitizeForLog_WithExtendedAsciiCharacter_PreservesCharacter()
    {
    ...
    [Fact]
    public void SanitizeForLog_WithUnicodeCharacters_PreservesCharacters()
    {
    ...
    [Fact]
    public void SanitizeForLog_WithSpanishCharacters_PreservesCharacters()
    {
    ...
    [Fact]
    public void SanitizeForLog_WithAllPrintableAsciiRange_ReturnsUnchanged()
    {
    ...
    public void SanitizeForLog_WithLogInjectionAttempts_RemovesInjectionVectors(string input, string expected)
    {
        // Act
        var result = input.SanitizeForLog();
    ...
    [Fact]
    public void SanitizeForLog_WithLogInjectionAndNullBytes_RemovesInjectionVectors()
    {
        // Arrange
    ...
    [InlineData(" ", " ")]
    [InlineData("}", "}")]
    public void SanitizeForLog_WithBoundaryCharacters_HandlesCorrectly(string input, string expected)
    {
        // Act
        var result = input.SanitizeForLog();
    ...
    [Fact]
    public void SanitizeForLog_WithLongString_HandlesPerformance()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_PreservesSpaces()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_WithAllControlCharacters_ReplacesAll()
    {
    ...
    [Fact]
    public void SanitizeForLog_WithCharacter127_ReplacesWithSpace()
    {
        // Arrange
    ...
    [Fact]
    public void SanitizeForLog_HandlesNull()
    {
        // Arrange
        string? input = null;
