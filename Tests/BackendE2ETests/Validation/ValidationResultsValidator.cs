...
/// FHIR validation results for the report. Explains why ReportingStatus=FailedValidation
/// by showing the actual severity counts, top error messages, and category breakdowns.
/// </summary>
public class ValidationResultsValidator(RestClient client, ITestOutputHelper output)
{
    ...
    private async Task ValidateReportResults(string facilityId, string reportId)
    {
        ...
        try
        {
            ...
            // Show top 5 error/fatal messages for quick diagnosis
            var errors = results
                .Where(r =>
                {
